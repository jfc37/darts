...
import { OhOnePlayer } from "./oh-one-player";
...
export class GolfTeam {
    ...
    public firstThrower!: OhOnePlayer;
    public secondThrower!: OhOnePlayer;
    ...
    public addPlayers(firstThrower: string, secondThrower: string) {
        this.firstThrower = OhOnePlayer.NewPlayer(firstThrower);
        this.secondThrower = OhOnePlayer.NewPlayer(secondThrower);
    }
